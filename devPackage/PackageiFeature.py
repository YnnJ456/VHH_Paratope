...
class iFeature:
    ...
    def QSOrder(self, nlag=30, w=0.1):
        ...
        dataFile1 = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[
            0]) + r'\iFeaturedata\Grantham.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(
            os.path.realpath(__file__))[0]) + '/iFeaturedata/Grantham.txt'
    ...
    def Geary(self, props=['CIDH920105', 'BHAR880101', 'CHAM820101', 'CHAM820102', 'CHOC760101', 'BIGC670101', 'CHAM810101', 'DAYM780201'],
              nlag=30):

        AA = 'ARNDCQEGHILKMFPSTWYV'
        fileAAidx = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[
            0]) + r'\iFeaturedata\AAidx.txt' if platform.system() == 'Windows' else sys.path[0] + '/iFeaturedata/AAidx.txt'
    ...
    def NMBroto(self, props=['CIDH920105', 'BHAR880101', 'CHAM820101', 'CHAM820102','CHOC760101', 'BIGC670101', 'CHAM810101', 'DAYM780201'], nlag=30):
        AA = 'ARNDCQEGHILKMFPSTWYV'
        fileAAidx = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[
            0]) + r'\iFeaturedata\AAidx.txt' if platform.system() == 'Windows' else sys.path[0] + '/iFeaturedata/AAidx.txt'
        with open(fileAAidx) as f:
    ...
    def AAINDEX(self, **kw):
        ...
        fileAAindex = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[
            0]) + r'\iFeaturedata\AAindex.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(
            os.path.realpath(__file__))[0]) + '/iFeaturedata/AAindex.txt'
